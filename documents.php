...
<?php
    ...
    foreach($result as $value) {
        ...
        $documents.="<form action=\"uploadDocs.php?doc=".$value["docId"]."&id=".$value["docId"]."\" method=\"post\" enctype=\"multipart/form-data\"> <input id=\"editProfilePic".$value["docId"]."\" accept=\".jpeg,.jpg,.png\" style=\"display:none;\" id=\"editProfile\" type=\"file\" name=\"pic".$value["docId"]."\"> <input class=\"inputSubmit salvar".$value["docId"]."\" type=submit value=\"SALVAR\"> </form> ";
        $documents.="</div>";
    }
    echo "</style>";
